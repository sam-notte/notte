...
from notte_core.controller.actions import BaseAction, FillAction, MFAAction, SelectDropdownOptionAction
...
class BaseVault(ABC):
    ...
    def replace_credentials(
        ...
        if not isinstance(action, (FillAction, SelectDropdownOptionAction, MFAAction)):
