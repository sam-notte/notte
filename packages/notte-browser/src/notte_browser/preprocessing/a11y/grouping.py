...
from notte_core.errors.processing import InvalidA11yChildrenError, InvalidInternalCheckError

from notte_browser.preprocessing.a11y.utils import (
    add_group_role,
    children_roles,
...
def group_interaction_children(node: A11yNode) -> A11yNode:
    ...
    nb_interactions = sum(
        [
            child.get("children_roles_count", {}).get(interaction_role, 0)
