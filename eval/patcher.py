...
class AgentPatcher:
    ...
    def __init__(self):
        ...
        self.prepatch_methods: dict[
            AgentPatcher.PatchType, dict[str, Callable[..., Any]]
        ] = defaultdict(dict)
    ...
    def _patch_function(
        ...
        if func.__qualname__ in self.prepatch_methods[patch_type]:
            raise CantPatchFunctionError(
                f"Function {func.__qualname__} already patched"
            )
    ...
    def log_io(self, class_with_methods: HasAccessors, functions: list[str]) -> None:
        ...
        def input_decorator(func: Callable[..., Any]) -> Callable[..., Any]:
            ...
            def _func_replacer(*args, **kwargs):
                ...
                self.input_data[func.__qualname__].append(
                    AgentPatcher._dump_args(params)
                )
                ...
                if asyncio.iscoroutinefunction(func):
                    ...
                    async def async_wrapper():
                        ...
                        self.output_data[func.__qualname__].append(
                            AgentPatcher._dump_args(retval)
                        )
                        return retval
    ...
    def log_timings(
        self, class_with_methods: HasAccessors, timing_methods: list[str]
    ) -> None:
