...
<Tabs>
  <Tab title="Web Agents">
    <Tip>
    Learn more about web agents in the [web agents](/side/fullstack/agents) guide.
    </Tip>
  ...
  <Tab title="Browser Sessions">
    <Tip>
    Learn more about browser sessions in the [browser sessions](/side/fullstack/sessions) guide.
    </Tip>
  ...
  <Tab title="Page Interactions">
    <Tip>
    Learn more about page interactions in the [page interactions](/side/fullstack/page_interactions) guide.
    </Tip>
  ...
  <Tab title="Vaults & Secrets">
    <Tip>
    Learn more about vaults and secrets in the [vaults and secrets](/side/fullstack/vault) guide.
    </Tip>
