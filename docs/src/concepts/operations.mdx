...
These operations offer more granular control over what's actually executed in a browser session compared to the [agent](/side/fullstack/agents) operations.
