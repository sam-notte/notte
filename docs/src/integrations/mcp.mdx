...
The Notte-MCP implementation directly mirrors the [Notte API offering](docs.notte.cc). With Notte-MCP, LLM systems can extend their capabilities to browser control, solving even complex tasks:
    ...
    ```json
{
    "mcpServers": {
        "notte-mcp": {
          ...
          "env": {
            "NOTTE_API_KEY": "sk-notte-7b2997e8fab49375f1ce2a29c1cd94ed348e91c73153e51b5992a0e6f6087fde"
          }
        }
    }
}
