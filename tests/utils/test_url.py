...
def test_get_root_domain_with_https():
    ...
    assert get_root_domain("https://subdomain.example.com") == "subdomain.example.com"
...
def test_get_root_domain_with_http():
    ...
    assert get_root_domain("http://subdomain.example.com") == "subdomain.example.com"
...
def test_get_root_domain_without_protocol():
    ...
    assert get_root_domain("subdomain.example.com") == "subdomain.example.com"
...
def test_get_root_domain_with_complex_domains():
    ...
    assert get_root_domain("subdomain.example.co.uk") == "subdomain.example.co.uk"
    assert get_root_domain("example.com:8080") == "example.com:8080"
    assert get_root_domain("example.com:8080/path") == "example.com:8080"
...
def test_get_root_domain_with_ip_addresses():
    ...
    assert get_root_domain("http://192.168.1.1:8080") == "192.168.1.1:8080"
